...
/**
 * This class is used to define how to synthesize audio in universal maner for
 * both SF2 and DLS instruments.
 *
...
public class ModelPerformer {
    ...
    public String toString(){
        String r=""+this.oscillators.get(0);
        //r=r+"\n	    oscillators: "+this.oscillators.size();
        //r=r+": 0: "+this.oscillators.get(0);
        //r=r+"\n	    connectionBlocks: "+this.connectionBlocks.size();
        return r;
    }
}
