 ...
 * have any questions.
 */
package nocom.sun.media.sound;

/**
 * Connection blocks are used to connect source variable to a destination
 * variable. For example Note On velocity can be connected to output gain. In
 * DLS this is called articulator and in SoundFonts (SF2) a modulator.
 *
